...
export function PatientsClient({ searchParams }: PatientsPageProps) {
  const { t } = useLanguage()
    ...
    <div className="min-h-screen bg-gray-50/50 print:min-h-0 print:h-auto print:overflow-visible print:bg-white">
      <div className="flex-1 space-y-6 p-6 print:p-0 print:space-y-0">
        ...
        <div className="flex items-center justify-between print:hidden">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">{t("patients")}</h1>
        ...
        <Card className="border-0 shadow-md print:hidden">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-gray-900">{t("search")}</CardTitle>
                <CardDescription>{t("filter")}</CardDescription>
              </div>
        ...
        <div className="print-area">
          <Card className="border-0 shadow-md print:shadow-none print:border-0">
            <CardHeader className="print:hidden">
              <CardTitle className="text-gray-900">{t("patients")}</CardTitle>
